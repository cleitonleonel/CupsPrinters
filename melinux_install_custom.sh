...
apt install samba -y
apt install apache2 php php-cli libapache2-mod-php curl -y
curl -sS https://getcomposer.org/installer | php 
mv composer.phar /usr/local/bin/composer
apt install git php-gd php-xml php-xmlrpc php-curl php-soap php-zip php-mbstring libphp-embed -y
...
mv /usr/local/bin/wkhtmltopdf /usr/bin
